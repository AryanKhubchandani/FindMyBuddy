...
class _SettingsPageState extends State<SettingsPage> {
  ...
  getInfo() async {
    myName = (await SharedPrefs().getDisplayName())!;
    myImage = (await SharedPrefs().getUserProfileUrl())!;
  ...
  void updateImg() async {
    await SharedPrefs().saveUserProfileUrl(url);

    FirebaseFirestore.instance
        .collection("users")
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .update({'imgUrl': SharedPrefs().getUserProfileUrl()});
  }

  void updateName() async {
    await SharedPrefs().saveDisplayName(nameController.text);
    FirebaseFirestore.instance
        .collection("users")
        .doc(FirebaseAuth.instance.currentUser!.uid)
